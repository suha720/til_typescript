...
arr.forEach((item, index) => {
  console.log(index); // 0, 1, 2, 3 위치 번호
  console.log(item);
});
```

- map : 원본 배열에서 `새로운 배열`을 만든다. (별표 10만개)
...
Object.keys(obj); // [age, nickName, isMember] 배열로 나옵니닷
...
Object.values(obj); // [10, hong, true] 배열로 나옵니닷
...
Object.entries(obj); // [10, hong, true] 배열로 나옵니닷
